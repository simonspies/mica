    ...
    | .ifThenElse cond thn els => by
        ...
        | mk thnTy thn' =>
          ...
          | mk elsTy els' =>
            ...
            simp [Expr.runtime, Untyped.Expr.runtime, ihCond _ hcond, ihThn _ hthn, ihEls _ hels]
        ...
        | mk scrutTy scrut' =>
          ...
          | sum ts =>
            ...
            · simp [hlen] at hcont
              ...
              simp [Expr.runtime, Untyped.Expr.runtime, ihScrut _ hscrut, ihBranches ts _ hbranches]
            · simp [hlen] at hcont
          | _ =>
            simp at hcont
